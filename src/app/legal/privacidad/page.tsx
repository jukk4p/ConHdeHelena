  ...
  return (
    <div className="py-20 md:py-32">
      <AnimatedSection className="container px-4 md:px-6">
        ...
        <div className="prose prose-lg max-w-none prose-p:text-muted-foreground prose-h2:font-headline prose-h2:text-foreground prose-h2:text-3xl prose-h2:font-bold prose-ul:list-disc prose-ul:pl-6 prose-ul:space-y-2">
            <AnimatedItem>
                <p>
            ...
            <AnimatedItem>
                <h2 className="mt-10 mb-4">1. Qué datos recopilamos</h2>
                <p>
            ...
            <AnimatedItem>
                <h2 className="mt-10 mb-4">2. Cómo usamos tus datos personales</h2>
                <p>
            ...
            <AnimatedItem>
                <h2 className="mt-10 mb-4">3. Seguridad de los datos</h2>
                <p>
